...
{
	/**
	 * @brief Evento responsável pela captura da posição do mouse.
	 */
	...
	/**
	 * @brief Evento responsável pela captura de botões do mouse pressionados.
	 */
	...
	/**
	 * @brief Evento responsável pela captura de botões do mouse recentemente soltos.
	 */
	...
	/**
	 * @brief Evento responsável pela captura do scroll do mouse.
	 */
