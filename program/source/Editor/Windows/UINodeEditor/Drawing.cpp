...
namespace editor::nodes::drawing
{
	...
	void DrawFlow(ImDrawList* drawList, bool filled, ImRect rect, float rect_w, float outline_scale, ImColor color, ImColor innerColor)
	{
	...
	void DrawIcon(ImDrawList* drawList, const ImVec2& a, const ImVec2& b, IconType type, bool filled, ImColor color, ImColor innerColor)
	{
	    ...
	    {
	    	DrawFlow(drawList, filled, rect, rect_w, outline_scale, color, innerColor);
	    }
	    else
	    {
	        ...
	        {
	        	DrawCircle(drawList, filled, rect_center, rect_w, outline_scale, extra_segments, color, innerColor);
	        }

	        if (type == IconType::Square)
	        {
				DrawSquare(drawList, filled, rect_center, rect_w, outline_scale, color, innerColor);
	        }

	        if (type == IconType::Grid)
	        {
	        	DrawGrid(drawList, triangleStart, filled, rect_center, rect_w, rect_center_x, rect_center_y, color);
	        }

	        if (type == IconType::RoundSquare)
	        {
	        	DrawRoundSquare(drawList, filled, rect_center, rect_w, outline_scale, color, innerColor);
	        }

	        else if (type == IconType::Diamond)
	        {
	        	DrawDiamond(drawList, filled, rect_center, rect_w, outline_scale, color, innerColor);
	        }
