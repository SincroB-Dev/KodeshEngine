...
#define REGISTER_FIELD_1(field) RegisterField(this, field, #field, sizeof(field))
#define REGISTER_FIELD_2(field, title) RegisterField(this, field, title, sizeof(field))
